...
public class ExecuteExchange {
    ...
    public void execute() {
        //generate test data
        Map<Currency, BigDecimal> currencyBigDecimalMap = new HashMap<>();
        ...
        userDao.saveUser(new UserAccount("Maksym", "Korbiak", currencyBigDecimalMap));
        ...
        Runnable runnable1 = () -> exchangeService.exchangeCurrency("Maksym", "Korbiak", ExchangeType.EUR_TO_UAH, BigDecimal.valueOf(12));
        Runnable runnable2 = () -> exchangeService.exchangeCurrency("Maksym", "Korbiak", ExchangeType.EUR_TO_UAH, BigDecimal.valueOf(12));
        Runnable runnable3 = () -> exchangeService.exchangeCurrency("Maksym", "Korbiak", ExchangeType.UAH_TO_USD, BigDecimal.valueOf(1300));
        ...
        UserAccount result = userDao.getUser("Maksym", "Korbiak");
        log.info("-------------------------------");
